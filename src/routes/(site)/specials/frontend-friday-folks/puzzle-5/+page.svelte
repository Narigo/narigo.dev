<script>
	...
	const firstSolution = `<div class="c r"></div>
<div class="d m"></div>
<div class="d l"></div>
<style>
...
<PuzzlePageLayout title="Acid Rain">
	...
	<Puzzle title="Second solution for puzzle 5" solution={secondSolution} />
	<Narigo>
		This is the second solution, half a year later. Is it better or worse now...? Since it's been
		half a year already, I should maybe do it a third time...
	</Narigo>
</PuzzlePageLayout>
