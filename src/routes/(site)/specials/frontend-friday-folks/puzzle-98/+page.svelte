...
<PuzzlePageLayout title="Candle">
	<Puzzle title="Solution" {solution} />
	<Narigo>
		<p>
			The flame was definitely easier to do with border radius. I think this is something I
			shouldn't even try with gradients anymore... 😅
		</p>
	</Narigo>
</PuzzlePageLayout>
