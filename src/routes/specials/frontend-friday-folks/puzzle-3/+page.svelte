<script>
	...
	const solutionFirst = `<div class="bg-rect">
...
<style>
  ...
  .button {
	...
	const solutionGradient = `<div></div>
<style>
  body {
    background: #6592CF;
    display: grid;
...
<PuzzlePageLayout title="Push Button">
	...
	<Narigo
		...
		a radial-gradient and moving the background position seemed to make sense to me.</Narigo
	>
</PuzzlePageLayout>
