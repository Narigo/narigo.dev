...
<PageLayout>
	...
	<Narigo
		>In VirtualCoffee.io, we started a group that meets every Friday to work on a CSSBattle.dev
	...
	<ul>
		...
		<li><a href="{base}/specials/frontend-friday-folks/puzzle-38">Puzzle 38 - Not Simply Square</a></li>
