...
<PuzzlePageLayout title="Command Key">
	...
	<Narigo>
		...
		day later on my own. I like <code>-webkit-box-reflect</code>, but I'm always a bit surprised how
		it works - especially when using absolute or fixed positioning and pseudo-elements. I think, I
