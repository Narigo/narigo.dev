...
<PageLayout>
	...
	<AnimationContext name="dialog">
		...
		<Narigo delay={1000} side="right">I thought I may want to write some code here.</Narigo>
		<Bubble delay={1000}>Okay, but ...</Bubble>
		<Bubble delay={1000}>what?</Bubble>
		<Narigo delay={1000} side="right">For example an animation for this "exchange" here.</Narigo>
