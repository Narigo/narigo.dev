...
<PageLayout>
	...
	<AnimationContext name="dialog">
		...
		<Bubble delayNext={1000}>what?</Bubble>
		<Narigo delayNext={1000} side="right">For example an animation for this "exchange" here.</Narigo
		>
		<Narigo delayNext={1000} side="right"
