import{S as Gr,i as Qr,s as zr,w as Mr,x as Wr,y as Fr,f as Nr,t as Vr,z as jr,k as r,q as a,a as d,l as n,m as s,r as i,h as e,c as p,n as I,N as Kr,b as h,G as o,B as Jr}from"../../../../chunks/index-ed5c000a.js";import{C as Xr}from"../../../../chunks/CodeBlock-718745a2.js";import{P as Yr}from"../../../../chunks/PageLayout-59cb6841.js";const Zr=""+new URL("../../../../assets/boards-manager-a9b14f77.png",import.meta.url).href;function tn(Ot){let f,O,m,g,J,ge,C,Co,Ct,Ao,De,X,Bo,Pe,Y,xo,Se,A,Lo,N,$o,Ho,Te,Z,qo,Ue,tt,Ro,Oe,B,At,Mo,Wo,Bt,Fo,Ce,et,No,Ae,y,Vo,xt,jo,Go,Lt,Qo,zo,$t,Ko,Jo,Ht,Xo,Yo,Be,ot,Zo,xe,E,ta,V,ea,oa,qt,aa,ia,Rt,la,ra,Le,at,na,$e,it,sa,He,D,ha,Mt,da,pa,Wt,ca,ua,qe,lt,fa,Re,rt,ma,Me,nt,wa,We,st,ba,Fe,ht,ya,Ne,dt,va,Ve,pt,Ia,je,k,Ea,Ft,ka,_a,Nt,ga,Da,Vt,Pa,Sa,Ge,ct,Ta,Qe,j,ze,ut,Ua,Ke,ft,Oa,Je,mt,Ca,Xe,x,Aa,G,Ba,xa,Ye,wt,La,Ze,P,$a,jt,Ha,qa,Gt,Ra,Ma,to,L,pl,eo,bt,Wa,oo,yt,Fa,ao,$,Na,Qt,Va,ja,io,vt,Ga,lo,It,Qa,ro,S,Q,za,zt,Ka,Ja,Xa,Kt,Ya,Za,Jt,ti,no,Et,ei,so,kt,oi,ho,c,Xt,ai,ii,Yt,li,ri,Zt,ni,si,te,hi,di,z,pi,ee,ci,ui,fi,oe,mi,wi,ae,bi,yi,ie,vi,po,_t,Ii,co,gt,Ei,uo,_,ki,le,_i,gi,re,Di,Pi,ne,Si,Ti,fo,v,Ui,se,Oi,Ci,he,Ai,Bi,de,xi,Li,pe,$i,Hi,mo,H,qi,ce,Ri,Mi,wo,q,ue,fe,Wi,Fi,me,we,Ni,bo,u,Vi,be,ji,Gi,ye,Qi,zi,ve,Ki,Ji,Ie,Xi,Yi,Ee,Zi,tl,ke,el,ol,_e,al,il,yo,Dt,ll,vo,Pt,rl,Io,R,nl,K,sl,hl,Eo;return j=new Xr({props:{code:Ot[0]}}),{c(){f=r("p"),O=a(`Be aware, I'm going to continue writing and improving on this article. Maybe the parts I release
		...
		right before Easter holidays in Germany, so I had some time to assemble it.`),Pe=d(),Y=r("p"),xo=a(`While I was pretty shocked to learn that I had to solder a battery onto this mini computer for
		it to work, I'm pretty happy with the result. Since I'm pretty much new to working with
		hardware, I want to share what I had to do in order to get to a result.`),Se=d(),A=r("p"),Lo=a("If you haven't checked out the "),N=r("a"),$o=a("documentation of the Pocuter One"),Ho=a(", it's definitely something to look at first."),Te=d(),Z=r("h3"),qo=a("WatchKit assembly"),Ue=d(),tt=r("p"),Ro=a("There are a few things that need to be done before playing around with apps:"),Oe=d(),B=r("ol"),At=r("li"),Mo=a("Solder a battery to the chip"),Wo=d(),Bt=r("li"),Fo=a("Assemble the watch itself"),Ce=d(),et=r("h4"),No=a("Soldering the battery"),Ae=d(),y=r("p"),Vo=a(`The very first one was the most intimidating for me as someone who doesn't have much experience
		with hardware. I wasn't sure which cable needs to go to which pole, since the only thing I saw
		was a red and a black cable and the `),xt=r("code"),jo=a("+"),Go=a(" and "),Lt=r("code"),Qo=a("-"),zo=a(` symbols on the chip. So my
		first research was about whether the red or the black cable is `),$t=r("code"),Ko=a("+"),Jo=a(" or "),Ht=r("code"),Xo=a("-"),Yo=a("."),Be=d(),ot=r("p"),Zo=a(`When I researched cable color codes, I found conflicting information based on what part of the
		world you are in. I know that the company that sells the computer is based in Germany, but as
		far as I understand it, the parts come from China.`),xe=d(),E=r("p"),ta=a("Long story short, in "),V=r("a"),ea=a("the Pocuter Discord"),oa=a(`, people shared pictures of how they put batteries on the board. I could infer that the red
		cable goes to the `),qt=r("code"),aa=a("+"),ia=a(" pole and the black cable to the "),Rt=r("code"),la=a("-"),ra=a(` pole. I can definitly
		recommend joining their Discord as they seem to be very active and helpful regarding support.`),Le=d(),at=r("p"),na=a(`To be able to solder a cable, I had to cut the outer parts of the wire, so the metallic inside
		...
		can hit it with my relatively big soldering iron.`),$e=d(),it=r("p"),sa=a(`I put the cables from "below" into the holes. "Below" means when folding the screen on top of
		...
		and restarting it yielded all the apps in there.`),Ke=d(),ft=r("p"),Oa=a("Writing my own app took a bit longer..."),Je=d(),mt=r("h3"),Ca=a("Writing an app for the Pocuter"),Xe=d(),x=r("p"),Aa=a(`To develop an application for the Pocuter, it's necessary to have a build setup that allows to
		compile code to the Arduino. It's possible to do this in different ways, the easiest is to use
		the `),G=r("a"),Ba=a("Arduino IDE"),xa=a(`. In the current
		...
		second item on the left side.`),to=d(),L=r("img"),eo=d(),bt=r("p"),Wa=a(`As far as I understood it, you need the various boards to be able to actually compile code for
		them. As soon as the board is there, writing an application and compiling it should work.`),oo=d(),yt=r("h4"),Fa=a("Connecting the Pocuter"),ao=d(),$=r("p"),Na=a(`This one was tricky when working with my Mac OS Ventura. There are quite a few blog posts out
		...
		make this work. There is a line `),de=r("code"),xi=a("pocuterone.upload.tool=esptool_py"),Li=a(` which needed to
		be changed to
		`),pe=r("code"),$i=a("pocuterone.upload.tool.serial=esptool_py"),Hi=a(`. After this change, uploading through the
		...
		recommend joining their Discord as they seem to be very active and helpful regarding support.`),M.forEach(e),Le=p(t),at=n(t,"P",{});var Ol=s(at);na=i(Ol,`To be able to solder a cable, I had to cut the outer parts of the wire, so the metallic inside
		is visible. There are specialized tools for doing that and trying to cut it off with something
		sharp resulted in losing quite a bit of the wire itself. I then found a small tool I could use
		that I got from some random hackathon or conference that I attended. It worked out, but it was
		quite painful to get it done. Anyways, once you see the metallic inside of the red and the black
		wires from the battery, you can solder it. I opened it a couple of millimeters, so I was sure I
		can hit it with my relatively big soldering iron.`),Ol.forEach(e),$e=p(t),it=n(t,"P",{});var Cl=s(it);sa=i(Cl,`I put the cables from "below" into the holes. "Below" means when folding the screen on top of
		the chip as it needs to be put in the watch case, the battery is below the chip. The red and
		black cables from the battery then don't need to be wrapped around the chip in the small watch
		...
		easier to put the soldering down on the less exposed port first, so fixing something wouldn't
		automatically mean I have to remove the potentially working and more exposed
		`),Wt=n(St,"CODE",{});var Bl=s(Wt);ca=i(Bl,"+"),Bl.forEach(e),ua=i(St," port as well."),St.forEach(e),qe=p(t),lt=n(t,"P",{});var xl=s(lt);fa=i(xl,`While soldering, the watch started to boot up. For me, this was the sign that the soldering
		worked out well and I made sure both cables were properly fixed. I made sure the soldered metal
		wasn't too high, so the screen wouldn't be hurt by that. I had to take off some of the soldering
		again by using the hot soldering iron and gently draw something away from it again. I guess it
		was pure luck that I didn't destroy anything while doing that - the pocuter continued to work!`),xl.forEach(e),Re=p(t),rt=n(t,"P",{});var Ll=s(rt);ma=i(Ll,`If the watch turned off at some point during the assembly, it wasn't because of my lack of
		experience with the soldering: The included battery runs out pretty quickly. I think when using
		the "Clock" application, it's running for about 1.5 hours after having the USB connected for an
		extended period of time.`),Ll.forEach(e),Me=p(t),nt=n(t,"H4",{});var $l=s(nt);wa=i($l,"Assembly of the watch kit"),$l.forEach(e),We=p(t),st=n(t,"P",{});var Hl=s(st);ba=i(Hl,`Ok, so this looked pretty straightforward. The screen only has one place where it can go. I
		could see from the outside where the USB port and the buttons / knobs should be. The buttons
		were a bit too hard to put in and it felt a bit wrong to push them so hard into it. I made it,
		but once I put in all the screws, I couldn't really push the buttons at all or they were "always
		...
		and restarting it yielded all the apps in there.`),jl.forEach(e),Ke=p(t),ft=n(t,"P",{});var Gl=s(ft);Oa=i(Gl,"Writing my own app took a bit longer..."),Gl.forEach(e),Je=p(t),mt=n(t,"H3",{});var Ql=s(mt);Ca=i(Ql,"Writing an app for the Pocuter"),Ql.forEach(e),Xe=p(t),x=n(t,"P",{});var go=s(x);Aa=i(go,`To develop an application for the Pocuter, it's necessary to have a build setup that allows to
		compile code to the Arduino. It's possible to do this in different ways, the easiest is to use
		the `),G=n(go,"A",{href:!0,rel:!0});var zl=s(G);Ba=i(zl,"Arduino IDE"),zl.forEach(e),xa=i(go,`. In the current
		pocuter documentation, it's documented how to setup the Arduino IDE 1.x, but there is a version
		2 already. I've made it work with version 2 on my Mac before I got a working build setup with my
		currently favorite IDE, VSCode. I'm documenting how I set it up in both ways.`),go.forEach(e),Ye=p(t),wt=n(t,"H4",{});var Kl=s(wt);La=i(Kl,"Setup Arduino IDE 2.x"),Kl.forEach(e),Ze=p(t),P=n(t,"P",{});var Tt=s(P);$a=i(Tt,"First thing I had to do is adding the additional boards manager URL. They provided the URL "),jt=n(Tt,"CODE",{});var Jl=s(jt);Ha=i(Jl,"https://raw.githubusercontent.com/pocuter/ArduinoBoard/main/pocuter_arduino.json"),Jl.forEach(e),qa=i(Tt,`
		in their documentation and this value can be put into
		`),Gt=n(Tt,"CODE",{});var Xl=s(Gt);Ra=i(Xl,'Arduino IDE -> Settings ... > "Additional Boards Manager URLs"'),Xl.forEach(e),Ma=i(Tt,`. After doing
		this, the Pocuter board should be included in the "boards manager". The boards manager is the
		second item on the left side.`),Tt.forEach(e),to=p(t),L=n(t,"IMG",{src:!0,alt:!0,class:!0}),eo=p(t),bt=n(t,"P",{});var Yl=s(bt);Wa=i(Yl,`As far as I understood it, you need the various boards to be able to actually compile code for
		them. As soon as the board is there, writing an application and compiling it should work.`),Yl.forEach(e),oo=p(t),yt=n(t,"H4",{});var Zl=s(yt);Fa=i(Zl,"Connecting the Pocuter"),Zl.forEach(e),ao=p(t),$=n(t,"P",{});var Do=s($);Na=i(Do,`This one was tricky when working with my Mac OS Ventura. There are quite a few blog posts out
		there mentioning to install some third party USB drivers. Most of them seem to be outdated
		though and when I tried out a couple of these, the USB connection still didn't work for me. I
		took me a while to understand one crucial thing: USB cables are not equal to USB cables. There
		are some cables that only deliver current but no data. If you happen to try and use one of the
		...
		make this work. There is a line `),de=n(U,"CODE",{});var _r=s(de);xi=i(_r,"pocuterone.upload.tool=esptool_py"),_r.forEach(e),Li=i(U,` which needed to
		be changed to
		`),pe=n(U,"CODE",{});var gr=s(pe);$i=i(gr,"pocuterone.upload.tool.serial=esptool_py"),gr.forEach(e),Hi=i(U,`. After this change, uploading through the
		...
		get by using `),Ee=n(b,"CODE",{});var xr=s(Ee);Zi=i(xr,"find /dev/cu.usb*"),xr.forEach(e),tl=i(b,` when the Pocuter is connected with a USB cable that
		supports data transfer - as I mentioned earlier, this took me a while to figure out. The
		`),ke=n(b,"CODE",{});var Lr=s(ke);el=i(Lr,"BUILD_PATH"),Lr.forEach(e),ol=i(b,`
		is set to `),_e=n(b,"CODE",{});var $r=s(_e);al=i($r,"./build"),$r.forEach(e),il=i(b,` so it doesn't use some temporary directory and always needs to recompile
		...
		SD card. That means you'll be able to quickly write the whole app on it instead of using the SD
		card approach mentioned earlier.`),Oo.forEach(e),this.h()},h(){I(f,"class","info svelte-7arsvs"),I(C,"class","date svelte-7arsvs"),I(N,"href","https://pocuter.com/docs/pocuter-one"),I(N,"rel","external"),I(V,"href","https://discord.com/channels/762688795035697182/762688795035697186"),I(V,"rel","external"),I(G,"href","https://www.arduino.cc/en/software"),I(G,"rel","external"),Kr(L.src,pl=Zr)||I(L,"src",pl),I(L,"alt","The boards manager"),I(L,"class","svelte-7arsvs"),I(K,"href","https://github.com/kallistisoft/PocuterUtils"),I(K,"rel","external")},m(t,l){h(t,f,l),o(f,O),h(t,m,l),h(t,g,l),o(g,J),h(t,ge,l),h(t,C,l),o(C,Co),o(C,Ct),o(Ct,Ao),h(t,De,l),h(t,X,l),o(X,Bo),h(t,Pe,l),h(t,Y,l),o(Y,xo),h(t,Se,l),h(t,A,l),o(A,Lo),o(A,N),o(N,$o),o(A,Ho),h(t,Te,l),h(t,Z,l),o(Z,qo),h(t,Ue,l),h(t,tt,l),o(tt,Ro),h(t,Oe,l),h(t,B,l),o(B,At),o(At,Mo),o(B,Wo),o(B,Bt),o(Bt,Fo),h(t,Ce,l),h(t,et,l),o(et,No),h(t,Ae,l),h(t,y,l),o(y,Vo),o(y,xt),o(xt,jo),o(y,Go),o(y,Lt),o(Lt,Qo),o(y,zo),o(y,$t),o($t,Ko),o(y,Jo),o(y,Ht),o(Ht,Xo),o(y,Yo),h(t,Be,l),h(t,ot,l),o(ot,Zo),h(t,xe,l),h(t,E,l),o(E,ta),o(E,V),o(V,ea),o(E,oa),o(E,qt),o(qt,aa),o(E,ia),o(E,Rt),o(Rt,la),o(E,ra),h(t,Le,l),h(t,at,l),o(at,na),h(t,$e,l),h(t,it,l),o(it,sa),h(t,He,l),h(t,D,l),o(D,ha),o(D,Mt),o(Mt,da),o(D,pa),o(D,Wt),o(Wt,ca),o(D,ua),h(t,qe,l),h(t,lt,l),o(lt,fa),h(t,Re,l),h(t,rt,l),o(rt,ma),h(t,Me,l),h(t,nt,l),o(nt,wa),h(t,We,l),h(t,st,l),o(st,ba),h(t,Fe,l),h(t,ht,l),o(ht,ya),h(t,Ne,l),h(t,dt,l),o(dt,va),h(t,Ve,l),h(t,pt,l),o(pt,Ia),h(t,je,l),h(t,k,l),o(k,Ea),o(k,Ft),o(Ft,ka),o(k,_a),o(k,Nt),o(Nt,ga),o(k,Da),o(k,Vt),o(Vt,Pa),o(k,Sa),h(t,Ge,l),h(t,ct,l),o(ct,Ta),h(t,Qe,l),Fr(j,t,l),h(t,ze,l),h(t,ut,l),o(ut,Ua),h(t,Ke,l),h(t,ft,l),o(ft,Oa),h(t,Je,l),h(t,mt,l),o(mt,Ca),h(t,Xe,l),h(t,x,l),o(x,Aa),o(x,G),o(G,Ba),o(x,xa),h(t,Ye,l),h(t,wt,l),o(wt,La),h(t,Ze,l),h(t,P,l),o(P,$a),o(P,jt),o(jt,Ha),o(P,qa),o(P,Gt),o(Gt,Ra),o(P,Ma),h(t,to,l),h(t,L,l),h(t,eo,l),h(t,bt,l),o(bt,Wa),h(t,oo,l),h(t,yt,l),o(yt,Fa),h(t,ao,l),h(t,$,l),o($,Na),o($,Qt),o(Qt,Va),o($,ja),h(t,io,l),h(t,vt,l),o(vt,Ga),h(t,lo,l),h(t,It,l),o(It,Qa),h(t,ro,l),h(t,S,l),o(S,Q),o(Q,za),o(Q,zt),o(zt,Ka),o(Q,Ja),o(S,Xa),o(S,Kt),o(Kt,Ya),o(S,Za),o(S,Jt),o(Jt,ti),h(t,no,l),h(t,Et,l),o(Et,ei),h(t,so,l),h(t,kt,l),o(kt,oi),h(t,ho,l),h(t,c,l),o(c,Xt),o(Xt,ai),o(c,ii),o(c,Yt),o(Yt,li),o(c,ri),o(c,Zt),o(Zt,ni),o(c,si),o(c,te),o(te,hi),o(c,di),o(c,z),o(z,pi),o(z,ee),o(ee,ci),o(z,ui),o(c,fi),o(c,oe),o(oe,mi),o(c,wi),o(c,ae),o(ae,bi),o(c,yi),o(c,ie),o(ie,vi),h(t,po,l),h(t,_t,l),o(_t,Ii),h(t,co,l),h(t,gt,l),o(gt,Ei),h(t,uo,l),h(t,_,l),o(_,ki),o(_,le),o(le,_i),o(_,gi),o(_,re),o(re,Di),o(_,Pi),o(_,ne),o(ne,Si),o(_,Ti),h(t,fo,l),h(t,v,l),o(v,Ui),o(v,se),o(se,Oi),o(v,Ci),o(v,he),o(he,Ai),o(v,Bi),o(v,de),o(de,xi),o(v,Li),o(v,pe),o(pe,$i),o(v,Hi),h(t,mo,l),h(t,H,l),o(H,qi),o(H,ce),o(ce,Ri),o(H,Mi),h(t,wo,l),h(t,q,l),o(q,ue),o(ue,fe),o(fe,Wi),o(q,Fi),o(q,me),o(me,we),o(we,Ni),h(t,bo,l),h(t,u,l),o(u,Vi),o(u,be),o(be,ji),o(u,Gi),o(u,ye),o(ye,Qi),o(u,zi),o(u,ve),o(ve,Ki),o(u,Ji),o(u,Ie),o(Ie,Xi),o(u,Yi),o(u,Ee),o(Ee,Zi),o(u,tl),o(u,ke),o(ke,el),o(u,ol),o(u,_e),o(_e,al),o(u,il),h(t,yo,l),h(t,Dt,l),o(Dt,ll),h(t,vo,l),h(t,Pt,l),o(Pt,rl),h(t,Io,l),h(t,R,l),o(R,nl),o(R,K),o(K,sl),o(R,hl),Eo=!0},p:Jr,i(t){Eo||(Nr(j.$$.fragment,t),Eo=!0)},o(t){Vr(j.$$.fragment,t),Eo=!1},d(t){t&&e(f),t&&e(m),t&&e(g),t&&e(ge),t&&e(C),t&&e(De),t&&e(X),t&&e(Pe),t&&e(Y),t&&e(Se),t&&e(A),t&&e(Te),t&&e(Z),t&&e(Ue),t&&e(tt),t&&e(Oe),t&&e(B),t&&e(Ce),t&&e(et),t&&e(Ae),t&&e(y),t&&e(Be),t&&e(ot),t&&e(xe),t&&e(E),t&&e(Le),t&&e(at),t&&e($e),t&&e(it),t&&e(He),t&&e(D),t&&e(qe),t&&e(lt),t&&e(Re),t&&e(rt),t&&e(Me),t&&e(nt),t&&e(We),t&&e(st),t&&e(Fe),t&&e(ht),t&&e(Ne),t&&e(dt),t&&e(Ve),t&&e(pt),t&&e(je),t&&e(k),t&&e(Ge),t&&e(ct),t&&e(Qe),jr(j,t),t&&e(ze),t&&e(ut),t&&e(Ke),t&&e(ft),t&&e(Je),t&&e(mt),t&&e(Xe),t&&e(x),t&&e(Ye),t&&e(wt),t&&e(Ze),t&&e(P),t&&e(to),t&&e(L),t&&e(eo),t&&e(bt),t&&e(oo),t&&e(yt),t&&e(ao),t&&e($),t&&e(io),t&&e(vt),t&&e(lo),t&&e(It),t&&e(ro),t&&e(S),t&&e(no),t&&e(Et),t&&e(so),t&&e(kt),t&&e(ho),t&&e(c),t&&e(po),t&&e(_t),t&&e(co),t&&e(gt),t&&e(uo),t&&e(_),t&&e(fo),t&&e(v),t&&e(mo),t&&e(H),t&&e(wo),t&&e(q),t&&e(bo),t&&e(u),t&&e(yo),t&&e(Dt),t&&e(vo),t&&e(Pt),t&&e(Io),t&&e(R)}}}function en(Ot){let f,O;return f=new Yr({props:{$$slots:{default:[tn]},$$scope:{ctx:Ot}}}),{c(){Mr(f.$$.fragment)},l(m){Wr(f.$$.fragment,m)},m(m,g){Fr(f,m,g),O=!0},p(m,[g]){const J={};g&2&&(J.$$scope={dirty:g,ctx:m}),f.$set(J)},i(m){O||(Nr(f.$$.fragment,m),O=!0)},o(m){Vr(f.$$.fragment,m),O=!1},d(m){jr(f,m)}}}function on(Ot){return[`apps/
     1/
          esp32c3.app
     2/
          esp32c3.app
...
config/      (optionally)
     ...
     3/
     ...`]}class nn extends Gr{constructor(f){super(),Qr(this,f,on,en,zr,{})}}export{nn as default};
