import{s as P,a as v,c as x,i as f,d,l as _,m as w}from"../chunks/scheduler.Po0zCuFf.js";import{S,i as I,b as p,d as m,m as g,a as c,t as b,e as h}from"../chunks/index.WEWm72Kh.js";import{C as y}from"../chunks/Code.GrnAcMCy.js";import{N as F}from"../chunks/Narigo.QL-b8Gvg.js";import{P as E,a as C}from"../chunks/PuzzlePageLayout.NKclQcHW.js";function G($){let t;return{c(){t=_("::before")},l(e){t=w(e,"::before")},m(e,s){f(e,t,s)},d(e){e&&d(t)}}}function B($){let t;return{c(){t=_("::after")},l(e){t=w(e,"::after")},m(e,s){f(e,t,s)},d(e){e&&d(t)}}}function D($){let t,e,s,i,a,u;return e=new y({props:{$$slots:{default:[G]},$$scope:{ctx:$}}}),i=new y({props:{$$slots:{default:[B]},$$scope:{ctx:$}}}),{c(){t=_(`My first solution when we started playing these CSS battles. Instead of using two inner divs,
