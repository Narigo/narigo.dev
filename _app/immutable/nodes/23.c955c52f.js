import{s as N,a as C,c as S,i as p,d as u,l as g,m as d,f as T,g as D,A as F,j as y,y as G}from"../chunks/scheduler.8a7a49fc.js";import{S as H,i as M,b as _,d as h,m as b,a as z,t as v,e as w}from"../chunks/index.6f578239.js";import{C as k}from"../chunks/Code.d0a84767.js";import{B as U}from"../chunks/Bubble.cc5ed9aa.js";import{N as B}from"../chunks/Narigo.70679acd.js";import{P as j,a as P}from"../chunks/PuzzlePageLayout.ad01f991.js";function q($){let t;return{c(){t=g(`This is the first puzzle where I used multiple backgrounds with gradients. It's not optimized
		...
		yet, but the idea is clear.`)},m(e,r){p(e,t,r)},d(e){e&&u(t)}}}function L($){let t;return{c(){t=g("inset")},l(e){t=d(e,"inset")},m(e,r){p(e,t,r)},d(e){e&&u(t)}}}function W($){let t;return{c(){t=g("width")},l(e){t=d(e,"width")},m(e,r){p(e,t,r)},d(e){e&&u(t)}}}function E($){let t;return{c(){t=g("height")},l(e){t=d(e,"height")},m(e,r){p(e,t,r)},d(e){e&&u(t)}}}function J($){let t,e,r,i,a,f,m,c;return e=new k({props:{$$slots:{default:[L]},$$scope:{ctx:$}}}),i=new k({props:{$$slots:{default:[W]},$$scope:{ctx:$}}}),f=new k({props:{$$slots:{default:[E]},$$scope:{ctx:$}}}),{c(){t=g("Here is an improved version by leveraging the fact that "),_(e.$$.fragment),r=g(` is already telling CSS
		how big the box is. `),_(i.$$.fragment),a=g(` and
		`),_(f.$$.fragment),m=g(` settings are therefore not necessary. The second improvement is how the gradients
		are applied: Instead of using four different, it can do it in three, using multiple color stops.`)},l(s){t=d(s,"Here is an improved version by leveraging the fact that "),h(e.$$.fragment,s),r=d(s,` is already telling CSS
		how big the box is. `),h(i.$$.fragment,s),a=d(s,` and
