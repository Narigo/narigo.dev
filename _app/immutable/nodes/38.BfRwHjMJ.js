import{s as b,b as v,j as z,k as c,i as f,t as u,e as y,h as m,d as k,p as F}from"../chunks/scheduler.Ct-hQNXS.js";import{S as C,i as I,c as $,b as d,m as g,t as h,a as x,d as _}from"../chunks/index.DAUMTxUj.js";import{C as P}from"../chunks/Code.x-nWcPNg.js";import{N as E}from"../chunks/Narigo.DCh2BCzZ.js";import{P as S,a as O}from"../chunks/PuzzlePageLayout.DzOxJxqk.js";function X(i){let t;return{c(){t=u("transform: scaleX(-1)")},l(n){t=m(n,"transform: scaleX(-1)")},m(n,a){c(n,t,a)},d(n){n&&f(t)}}}function j(i){let t,n,a="border-radius",s,e,o,p;return e=new P({props:{$$slots:{default:[X]},$$scope:{ctx:i}}}),{c(){t=u("The solution with gradients does not feel so great and it seems to be much easier using "),n=y("code"),n.textContent=a,s=u(`
