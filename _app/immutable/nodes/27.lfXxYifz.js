import{s as P,b as v,j as x,k as f,i as d,t as _,h as w}from"../chunks/scheduler.Ct-hQNXS.js";import{S,i as I,c as p,b as m,m as g,t as c,a as b,d as h}from"../chunks/index.DAUMTxUj.js";import{C as y}from"../chunks/Code.x-nWcPNg.js";import{N as F}from"../chunks/Narigo.BkWV0FXI.js";import{P as E,a as C}from"../chunks/PuzzlePageLayout.CYBvy01F.js";function G($){let t;return{c(){t=_("::before")},l(e){t=w(e,"::before")},m(e,s){f(e,t,s)},d(e){e&&d(t)}}}function j($){let t;return{c(){t=_("::after")},l(e){t=w(e,"::after")},m(e,s){f(e,t,s)},d(e){e&&d(t)}}}function B($){let t,e,s,i,a,u;return e=new y({props:{$$slots:{default:[G]},$$scope:{ctx:$}}}),i=new y({props:{$$slots:{default:[j]},$$scope:{ctx:$}}}),{c(){t=_(`My first solution when we started playing these CSS battles. Instead of using two inner divs,
