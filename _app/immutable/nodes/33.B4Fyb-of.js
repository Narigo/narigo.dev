import{s as y,b as x,j as w,k as $,i as f,t as u,h as c}from"../chunks/scheduler.Ct-hQNXS.js";import{S as k,i as P,c as p,b as m,m as d,t as g,a as _,d as h}from"../chunks/index.DAUMTxUj.js";import{C as z}from"../chunks/Code.x-nWcPNg.js";import{N as C}from"../chunks/Narigo.BkWV0FXI.js";import{P as B,a as D}from"../chunks/PuzzlePageLayout.CYBvy01F.js";function F(r){let t;return{c(){t=u("::before")},l(e){t=c(e,"::before")},m(e,n){$(e,t,n)},d(e){e&&f(t)}}}function I(r){let t;return{c(){t=u("::after")},l(e){t=c(e,"::after")},m(e,n){$(e,t,n)},d(e){e&&f(t)}}}function N(r){let t,e,n,s,o,i;return e=new z({props:{$$slots:{default:[F]},$$scope:{ctx:r}}}),s=new z({props:{$$slots:{default:[I]},$$scope:{ctx:r}}}),{c(){t=u("Ok, I initially thought that "),p(e.$$.fragment),n=u(" and "),p(s.$$.fragment),o=u(` could be used for nesting.
...
`]}class G extends k{constructor(t){super(),P(this,t,j,S,y,{})}}export{G as component};
