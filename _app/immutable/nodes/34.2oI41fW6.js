import{s as I,b as w,j as k,k as $,i as d,t as _,h as v,e as P,d as F,p as S}from"../chunks/scheduler.Bz19wuGf.js";import{S as A,i as j,c as f,b as p,m as c,t as g,a as b,d as h}from"../chunks/index.D0WKZCG1.js";import{C as B}from"../chunks/Code.DH1kOu0O.js";import{N as y}from"../chunks/Narigo.DQgr8xcz.js";import{P as D,a as C}from"../chunks/PuzzlePageLayout.g9n0UzY0.js";function N(u){let e;return{c(){e=_(`In my first solution I used regular positioning and thought the left-bottom and middle one were
		...
		but it looks like it can only mirror on the X or the Y axis - not both at the same time. So I resorted
		to the `),p(i.$$.fragment,n),m=v(n," trick. For this to work, the boxes needed to be duplicated.")},m(n,t){$(n,e,t),$(n,o,t),$(n,a,t),c(i,n,t),$(n,m,t),l=!0},p(n,t){const r={};t&4&&(r.$$scope={dirty:t,ctx:n}),i.$set(r)},i(n){l||(g(i.$$.fragment,n),l=!0)},o(n){b(i.$$.fragment,n),l=!1},d(n){n&&(d(e),d(o),d(a),d(m)),h(i,n)}}}function Y(u){let e,o,s,a,i,m,l,n;return e=new C({props:{title:"Puzzle 4 solution",solution:u[0]}}),s=new y({props:{$$slots:{default:[N]},$$scope:{ctx:u}}}),i=new C({props:{title:"Second solution for puzzle 4",solution:u[1]}}),l=new y({props:{$$slots:{default:[X]},$$scope:{ctx:u}}}),{c(){f(e.$$.fragment),o=w(),f(s.$$.fragment),a=w(),f(i.$$.fragment),m=w(),f(l.$$.fragment)},l(t){p(e.$$.fragment,t),o=k(t),p(s.$$.fragment,t),a=k(t),p(i.$$.fragment,t),m=k(t),p(l.$$.fragment,t)},m(t,r){c(e,t,r),$(t,o,r),c(s,t,r),$(t,a,r),c(i,t,r),$(t,m,r),c(l,t,r),n=!0},p(t,r){const x={};r&4&&(x.$$scope={dirty:r,ctx:t}),s.$set(x);const z={};r&4&&(z.$$scope={dirty:r,ctx:t}),l.$set(z)},i(t){n||(g(e.$$.fragment,t),g(s.$$.fragment,t),g(i.$$.fragment,t),g(l.$$.fragment,t),n=!0)},o(t){b(e.$$.fragment,t),b(s.$$.fragment,t),b(i.$$.fragment,t),b(l.$$.fragment,t),n=!1},d(t){t&&(d(o),d(a),d(m)),h(e,t),h(s,t),h(i,t),h(l,t)}}}function q(u){let e,o;return e=new D({props:{title:"Ups n Downs",$$slots:{default:[Y]},$$scope:{ctx:u}}}),{c(){f(e.$$.fragment)},l(s){p(e.$$.fragment,s)},m(s,a){c(e,s,a),o=!0},p(s,[a]){const i={};a&4&&(i.$$scope={dirty:a,ctx:s}),e.$set(i)},i(s){o||(g(e.$$.fragment,s),o=!0)},o(s){b(e.$$.fragment,s),o=!1},d(s){h(e,s)}}}function E(u){return[`<div class="c r"></div>
<div class="d m"></div>
<div class="d l"></div>
<style>
...
`]}class J extends A{constructor(e){super(),j(this,e,E,q,I,{})}}export{J as component};
