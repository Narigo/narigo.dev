import{s as q,b as w,j as k,k as c,i as d,t as h,h as z,e as D,d as A,p as F,n as T}from"../chunks/scheduler.Ct-hQNXS.js";import{S as j,i as I,c as f,b as $,m,t as b,a as v,d as _}from"../chunks/index.DAUMTxUj.js";import{N as P}from"../chunks/Narigo.DCh2BCzZ.js";import{P as N,a as S}from"../chunks/PuzzlePageLayout.DzOxJxqk.js";function L(u){let e;return{c(){e=h("Again, having lots of fun with gradients!")},l(i){e=z(i,"Again, having lots of fun with gradients!")},m(i,n){c(i,e,n)},d(i){i&&d(e)}}}function G(u){let e,i,n="10px",o,r,g="no-repeat",l;return{c(){e=h("There is a minor improvement with this, by moving the background position down by "),i=D("code"),i.textContent=n,o=h(`
		using
